    ...
    <section id="featured-case-study" className="py-24 px-4 scroll-mt-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Impact & Results</h3>
            <div className="grid grid-cols-3 gap-3 md:gap-4">
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-300 mb-1">500K+</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Daily Operations</div>
              </div>
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-300 mb-1">45%</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Faster Uploads</div>
              </div>
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-300 mb-1">99.9%</div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {["NestJS", "TypeScript", "AWS S3", "Lambda", "BullMQ", "Redis", "MongoDB", "Docker", "Kubernetes"].map((tech) => (
                <span key={tech} className="bg-gray-100 dark:bg-gray-900/60 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm px-3 py-1.5 rounded-lg">
                  {tech}
                </span>
              ))}
            </div>
